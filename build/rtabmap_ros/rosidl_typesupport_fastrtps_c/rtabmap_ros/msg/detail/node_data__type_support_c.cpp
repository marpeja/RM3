...
#include "rosidl_runtime_c/primitives_sequence.h"  // cx, cy, depth, fx, fy, grid_empty_cells, grid_ground, grid_obstacles, height, image, laser_scan, user_data, width, word_descriptors, word_id_keys, word_id_values
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // cx, cy, depth, fx, fy, grid_empty_cells, grid_ground, grid_obstacles, height, image, laser_scan, user_data, width, word_descriptors, word_id_keys, word_id_values
