...
bool rtabmap_ros__msg__point2f__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * rtabmap_ros__msg__point2f__convert_to_py(void * raw_ros_message);
bool rtabmap_ros__msg__point2f__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * rtabmap_ros__msg__point2f__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__msg__odom_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._odom_info.OdomInfo", full_classname_dest, 35) == 0);
  }
  rtabmap_ros__msg__OdomInfo * ros_message = _ros_message;
  {  // header
  ...
  {  // local_bundle_models
    ...
    if (!sensor_msgs__msg__CameraInfo__Sequence__init(&(ros_message->local_bundle_models), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create sensor_msgs__msg__CameraInfo__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    sensor_msgs__msg__CameraInfo * dest = ros_message->local_bundle_models.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // local_bundle_model_transforms
    PyObject * field = PyObject_GetAttrString(_pymsg, "local_bundle_model_transforms");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'local_bundle_model_transforms'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!geometry_msgs__msg__Transform__Sequence__init(&(ros_message->local_bundle_model_transforms), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__Transform__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__Transform * dest = ros_message->local_bundle_model_transforms.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // words_values
    ...
    rtabmap_ros__msg__KeyPoint * dest = ros_message->words_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // local_map_values
    ...
    rtabmap_ros__msg__Point3f * dest = ros_message->local_map_values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // ref_corners
    ...
    if (!rtabmap_ros__msg__Point2f__Sequence__init(&(ros_message->ref_corners), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rtabmap_ros__msg__Point2f__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rtabmap_ros__msg__Point2f * dest = ros_message->ref_corners.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rtabmap_ros__msg__point2f__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // new_corners
    ...
    rtabmap_ros__msg__Point2f * dest = ros_message->new_corners.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rtabmap_ros__msg__point2f__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
PyObject * rtabmap_ros__msg__odom_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._odom_info");
  ...
  {  // local_bundle_model_transforms
    PyObject * field = NULL;
    size_t size = ros_message->local_bundle_model_transforms.size;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->local_bundle_model_transforms.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "local_bundle_model_transforms", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ref_corners
    ...
    rtabmap_ros__msg__Point2f * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->ref_corners.data[i]);
      PyObject * pyitem = rtabmap_ros__msg__point2f__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
