...
class Metaclass_OdomInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.msg import Point2f
...
class OdomInfo(metaclass=Metaclass_OdomInfo):
    ...
    __slots__ = [
        ...
        '_local_bundle_model_transforms',
        '_local_bundle_poses',
        '_transform',
        '_transform_filtered',
    ...
    _fields_and_field_types = {
        ...
        'local_bundle_models': 'sequence<sensor_msgs/CameraInfo>',
        'local_bundle_model_transforms': 'sequence<geometry_msgs/Transform>',
        ...
        'words_values': 'sequence<rtabmap_ros/KeyPoint>',
        'word_matches': 'sequence<int32>',
        'word_inliers': 'sequence<int32>',
        'local_map_keys': 'sequence<int32>',
        'local_map_values': 'sequence<rtabmap_ros/Point3f>',
        'local_scan_map': 'sensor_msgs/PointCloud2',
        'ref_corners': 'sequence<rtabmap_ros/Point2f>',
        'new_corners': 'sequence<rtabmap_ros/Point2f>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'Point2f')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'Point2f')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.BasicType('int32')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.local_bundle_model_transforms = kwargs.get('local_bundle_model_transforms', [])
    ...
    def __eq__(self, other):
        ...
        if self.local_bundle_models != other.local_bundle_models:
            return False
        if self.local_bundle_model_transforms != other.local_bundle_model_transforms:
            return False
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'local_bundle_models' field must be a set or sequence and each value of type 'CameraInfo'"
        self._local_bundle_models = value

    @property
    def local_bundle_model_transforms(self):
        """Message field 'local_bundle_model_transforms'."""
        return self._local_bundle_model_transforms

    @local_bundle_model_transforms.setter
    def local_bundle_model_transforms(self, value):
        if __debug__:
            from geometry_msgs.msg import Transform
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'local_bundle_model_transforms' field must be a set or sequence and each value of type 'Transform'"
        self._local_bundle_model_transforms = value
