...
#include "rtabmap_ros/msg/detail/node_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::Point3f &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::Point3f &);
size_t get_serialized_size(
  const rtabmap_ros::msg::Point3f &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::KeyPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::KeyPoint &);
size_t get_serialized_size(
  const rtabmap_ros::msg::KeyPoint &,
  size_t current_alignment);
size_t
...
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::GlobalDescriptor &);
size_t get_serialized_size(
  const rtabmap_ros::msg::GlobalDescriptor &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::EnvSensor &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::EnvSensor &);
size_t get_serialized_size(
  const rtabmap_ros::msg::EnvSensor &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const rtabmap_ros::msg::NodeData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::msg::NodeData & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: fx
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.fx[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: fy
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.fy[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: cx
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.cx[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: cy
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.cy[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: width
  ...
  // Member: height
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.height[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: baseline
  ...
  // Member: laser_scan
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.laser_scan[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: laser_scan_max_pts
  ...
  size_t current_alignment)
{
  ...
  // Member: gps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_GPS(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: grid_view_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_Point3f(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: word_kpts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: global_descriptors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_GlobalDescriptor(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: env_sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_EnvSensor(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::msg::NodeData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::msg::NodeData *>(
    untyped_ros_message);
...
{
  return max_serialized_size_NodeData(full_bounded, 0);
}
...
{
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_NodeData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, msg, NodeData)() {
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_NodeData__handle;
}
