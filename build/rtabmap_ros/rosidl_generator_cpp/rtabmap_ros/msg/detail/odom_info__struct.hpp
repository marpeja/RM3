...
#ifndef RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_HPP_
#define RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__msg__OdomInfo __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__msg__OdomInfo __declspec(deprecated)
#endif
...
struct OdomInfo_
{
  ...
  using _local_bundle_model_transforms_type =
  ...
  _local_bundle_model_transforms_type local_bundle_model_transforms;
  ...
  using _ref_corners_type =
    std::vector<rtabmap_ros::msg::Point2f_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_ros::msg::Point2f_<ContainerAllocator>>::other>;
  ...
  Type & set__local_bundle_model_transforms(
  ...
  {
    this->local_bundle_model_transforms = _arg;
    return *this;
  }
  ...
  Type & set__ref_corners(
    const std::vector<rtabmap_ros::msg::Point2f_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_ros::msg::Point2f_<ContainerAllocator>>::other> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rtabmap_ros::msg::OdomInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const rtabmap_ros::msg::OdomInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::msg::OdomInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__msg__OdomInfo
    std::shared_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__msg__OdomInfo
    std::shared_ptr<rtabmap_ros::msg::OdomInfo_<ContainerAllocator> const>
  ...
  bool operator==(const OdomInfo_ & other) const
  {
    ...
    if (this->local_bundle_model_transforms != other.local_bundle_model_transforms) {
      return false;
    }
...
using OdomInfo =
  rtabmap_ros::msg::OdomInfo_<std::allocator<void>>;
...
#endif  // RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_HPP_
