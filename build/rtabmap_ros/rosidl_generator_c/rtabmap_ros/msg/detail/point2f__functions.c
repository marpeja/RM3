...
{
  rtabmap_ros__msg__Point2f * msg = (rtabmap_ros__msg__Point2f *)malloc(sizeof(rtabmap_ros__msg__Point2f));
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__Point2f__Sequence__init(rtabmap_ros__msg__Point2f__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__Point2f *)calloc(size, sizeof(rtabmap_ros__msg__Point2f));
    if (!data) {
      return false;
    }
...
{
  rtabmap_ros__msg__Point2f__Sequence * array = (rtabmap_ros__msg__Point2f__Sequence *)malloc(sizeof(rtabmap_ros__msg__Point2f__Sequence));
  if (!array) {
    return NULL;
  }
