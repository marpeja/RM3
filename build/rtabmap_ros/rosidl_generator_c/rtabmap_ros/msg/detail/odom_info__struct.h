...
#ifndef RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_H_
#define RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_H_
...
// Struct defined in msg/OdomInfo in the package rtabmap_ros.
typedef struct rtabmap_ros__msg__OdomInfo
{
  ...
  sensor_msgs__msg__CameraInfo__Sequence local_bundle_models;
  geometry_msgs__msg__Transform__Sequence local_bundle_model_transforms;
  ...
  rtabmap_ros__msg__KeyPoint__Sequence words_values;
  ...
  rtabmap_ros__msg__Point3f__Sequence local_map_values;
  sensor_msgs__msg__PointCloud2 local_scan_map;
  rtabmap_ros__msg__Point2f__Sequence ref_corners;
  rtabmap_ros__msg__Point2f__Sequence new_corners;
  rosidl_runtime_c__int32__Sequence corner_inliers;
} rtabmap_ros__msg__OdomInfo;

// Struct for a sequence of rtabmap_ros__msg__OdomInfo.
typedef struct rtabmap_ros__msg__OdomInfo__Sequence
{
  rtabmap_ros__msg__OdomInfo * data;
...
#endif  // RTABMAP_ROS__MSG__DETAIL__ODOM_INFO__STRUCT_H_
