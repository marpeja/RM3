...
{
  rtabmap_ros__srv__RemoveLabel_Request * msg = (rtabmap_ros__srv__RemoveLabel_Request *)malloc(sizeof(rtabmap_ros__srv__RemoveLabel_Request));
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__srv__RemoveLabel_Request__Sequence__init(rtabmap_ros__srv__RemoveLabel_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__srv__RemoveLabel_Request *)calloc(size, sizeof(rtabmap_ros__srv__RemoveLabel_Request));
    if (!data) {
      return false;
    }
...
{
  rtabmap_ros__srv__RemoveLabel_Request__Sequence * array = (rtabmap_ros__srv__RemoveLabel_Request__Sequence *)malloc(sizeof(rtabmap_ros__srv__RemoveLabel_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rtabmap_ros__srv__RemoveLabel_Response * msg = (rtabmap_ros__srv__RemoveLabel_Response *)malloc(sizeof(rtabmap_ros__srv__RemoveLabel_Response));
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__srv__RemoveLabel_Response__Sequence__init(rtabmap_ros__srv__RemoveLabel_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__srv__RemoveLabel_Response *)calloc(size, sizeof(rtabmap_ros__srv__RemoveLabel_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rtabmap_ros__srv__RemoveLabel_Response__Sequence * array = (rtabmap_ros__srv__RemoveLabel_Response__Sequence *)malloc(sizeof(rtabmap_ros__srv__RemoveLabel_Response__Sequence));
  if (!array) {
    return NULL;
  }
