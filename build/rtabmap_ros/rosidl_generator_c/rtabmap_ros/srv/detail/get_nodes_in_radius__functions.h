...
#ifndef RTABMAP_ROS__SRV__DETAIL__GET_NODES_IN_RADIUS__FUNCTIONS_H_
#define RTABMAP_ROS__SRV__DETAIL__GET_NODES_IN_RADIUS__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_ros__srv__GetNodesInRadius_Request__init().
...
/**
 * It calls
 * rtabmap_ros__srv__GetNodesInRadius_Request__fini()
 ...
 * rtabmap_ros__srv__GetNodesInRadius_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_ros__srv__GetNodesInRadius_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rtabmap_ros__srv__GetNodesInRadius_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_ros
...
/**
 * It calls
 * rtabmap_ros__srv__GetNodesInRadius_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_ros
...
/**
 * It allocates the memory for the array and calls
 * rtabmap_ros__srv__GetNodesInRadius_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_ros
...
/**
 * It calls
 * rtabmap_ros__srv__GetNodesInRadius_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RTABMAP_ROS__SRV__DETAIL__GET_NODES_IN_RADIUS__FUNCTIONS_H_
