...
{
  rtabmap_ros__srv__AddLink_Request * msg = (rtabmap_ros__srv__AddLink_Request *)malloc(sizeof(rtabmap_ros__srv__AddLink_Request));
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__srv__AddLink_Request__Sequence__init(rtabmap_ros__srv__AddLink_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__srv__AddLink_Request *)calloc(size, sizeof(rtabmap_ros__srv__AddLink_Request));
    if (!data) {
      return false;
    }
...
{
  rtabmap_ros__srv__AddLink_Request__Sequence * array = (rtabmap_ros__srv__AddLink_Request__Sequence *)malloc(sizeof(rtabmap_ros__srv__AddLink_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rtabmap_ros__srv__AddLink_Response * msg = (rtabmap_ros__srv__AddLink_Response *)malloc(sizeof(rtabmap_ros__srv__AddLink_Response));
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__srv__AddLink_Response__Sequence__init(rtabmap_ros__srv__AddLink_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__srv__AddLink_Response *)calloc(size, sizeof(rtabmap_ros__srv__AddLink_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rtabmap_ros__srv__AddLink_Response__Sequence * array = (rtabmap_ros__srv__AddLink_Response__Sequence *)malloc(sizeof(rtabmap_ros__srv__AddLink_Response__Sequence));
  if (!array) {
    return NULL;
  }
