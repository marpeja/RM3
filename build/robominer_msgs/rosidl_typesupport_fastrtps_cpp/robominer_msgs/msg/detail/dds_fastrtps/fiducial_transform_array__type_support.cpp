...
#include "robominer_msgs/msg/detail/fiducial_transform_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const robominer_msgs::msg::FiducialTransform &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  robominer_msgs::msg::FiducialTransform &);
size_t get_serialized_size(
  const robominer_msgs::msg::FiducialTransform &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const robominer_msgs::msg::FiducialTransformArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robominer_msgs::msg::FiducialTransformArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        robominer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_FiducialTransform(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const robominer_msgs::msg::FiducialTransformArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robominer_msgs::msg::FiducialTransformArray *>(
    untyped_ros_message);
...
{
  return max_serialized_size_FiducialTransformArray(full_bounded, 0);
}
...
{
  return &robominer_msgs::msg::typesupport_fastrtps_cpp::_FiducialTransformArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robominer_msgs, msg, FiducialTransformArray)() {
  return &robominer_msgs::msg::typesupport_fastrtps_cpp::_FiducialTransformArray__handle;
}
