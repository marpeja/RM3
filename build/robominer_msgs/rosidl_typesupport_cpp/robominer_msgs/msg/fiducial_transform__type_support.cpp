...
static const _FiducialTransform_type_support_symbol_names_t _FiducialTransform_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robominer_msgs, msg, FiducialTransform)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robominer_msgs, msg, FiducialTransform)),
  }
};
...
{
  return &::robominer_msgs::msg::rosidl_typesupport_cpp::FiducialTransform_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robominer_msgs, msg, FiducialTransform)() {
  return get_message_type_support_handle<robominer_msgs::msg::FiducialTransform>();
}
