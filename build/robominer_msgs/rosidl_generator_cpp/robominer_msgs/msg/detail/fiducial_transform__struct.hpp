...
#ifndef ROBOMINER_MSGS__MSG__DETAIL__FIDUCIAL_TRANSFORM__STRUCT_HPP_
#define ROBOMINER_MSGS__MSG__DETAIL__FIDUCIAL_TRANSFORM__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__robominer_msgs__msg__FiducialTransform __attribute__((deprecated))
#else
# define DEPRECATED__robominer_msgs__msg__FiducialTransform __declspec(deprecated)
#endif
...
struct FiducialTransform_
{
  ...
  // pointer types
  using RawPtr =
    robominer_msgs::msg::FiducialTransform_<ContainerAllocator> *;
  using ConstRawPtr =
    const robominer_msgs::msg::FiducialTransform_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      robominer_msgs::msg::FiducialTransform_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__robominer_msgs__msg__FiducialTransform
    std::shared_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__robominer_msgs__msg__FiducialTransform
    std::shared_ptr<robominer_msgs::msg::FiducialTransform_<ContainerAllocator> const>
...
using FiducialTransform =
  robominer_msgs::msg::FiducialTransform_<std::allocator<void>>;
...
#endif  // ROBOMINER_MSGS__MSG__DETAIL__FIDUCIAL_TRANSFORM__STRUCT_HPP_
