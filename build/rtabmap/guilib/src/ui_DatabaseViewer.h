...
public:
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        page_4->setGeometry(QRect(0, -344, 518, 934));
        ...
        gridLayout_9->addWidget(label_logger_level_2, 16, 1, 1, 1);
        ...
        gridLayout_9->addWidget(checkBox_showDisparityInsteadOfRight, 16, 0, 1, 1);
        ...
        page_2->setGeometry(QRect(0, 0, 432, 196));
